...
if complicated: 
 ...
 #add a garage option for overnight parking
    ...
    st.write("It is likely that these values are out of data and need to be adjusted - check your electricity bill to update the value below.") 
    coe = st.slider('What do you expect to pay per kWh for electricity to charge your EV?',  value = round(float(nonpce - pce),2))#,max_value = 1.00)
